      ...
      $.ajax({
        ...
        .done(function( response ) {
                ...
                for(i=0; i<response.length; i++){
                    ...
                    male.push(response[i].male);
                    female.push(response[i].female);
                    sum.push(response[i].sum);
                    city_doctor_ratio.push(response[i].city_doctor_ratio);
                    city_population.push(response[i].city_population);
                    city_population_ratio.push(response[i].city_population_ratio);
                }
                // console.log(city);
